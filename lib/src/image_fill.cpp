...
template <>
    void image_fill < Image < unsigned char, MONO > >(Image < unsigned char,
                              MONO > *img,
                              visionsystem::Frame *
                              frm) {
    ...
    case VS_YUV422_UYVY:
        ...
        for (i = 0; i < img->pixels; i += 2) {
            ...
            img->raw_data[i+1] = frm->_data[2*i+3];
    ...
    default:
        throw(string
              ("Image<unsigned char,MONO> : CONVERSION NOT IMPLEMENTED"));
        break;
    }
}

inline void
__YUV422_YUYV_TO_RGB__(unsigned char *data, unsigned char *rgb_out)
{
    int y1, y2, u, v;
...
inline void
__YUV422_UYVY_TO_RGB__(unsigned char *data, unsigned char *rgb_out)
{
    int yy, uu, vv;
    int ug_plus_vg, ub, vr;
    int r, g, b;
...
template <>
    void image_fill < Image < uint32_t, RGB > >(Image < uint32_t, RGB > *img,
                        visionsystem::Frame * frm) {
    ...
    case VS_DEPTH16:
        ...
        for (i = 0; i < img->pixels; i++) {
            ...
            uint8_t R, G, B;
            R = G = B =
                (uint8_t) (((float) depth[i]) / 2048.0 * 255.0);
    ...
    case VS_YUV422_YYUV:
        throw(string
              ("Image<uint32_t,RGB> : CONVERSION YUV422_YYUV NOT IMPLEMENTED"));
        break;

    case VS_YUV422_YVYU:
        throw(string
              ("Image<uint32_t,RGB> : CONVERSION YUV422_YVYU NOT IMPLEMENTED"));
        break;
    ...
    case VS_YUV422_VYUY:
        throw(string
              ("Image<uint32_t,RGB> : CONVERSION YUV422_VYUY NOT IMPLEMENTED"));
        break;

    default:
        throw(string
              ("Image<uint32_t,RGB> : CONVERSION NOT IMPLEMENTED"));
        break;
    }
...
inline void
__RGB32_TO_HSV__(unsigned char *data, uint16_t & h, uint8_t & s, uint8_t & v)
{
    uint8_t r = 0;
    uint8_t g = 0;
    uint8_t b = 0;
...
template <>
    void image_fill < Image < uint32_t, HSV > >(Image < uint32_t, HSV > *img,
                        visionsystem::Frame * frm) {
    ...
    default:
        throw(string
              ("Image<uint32_t,HSV> : CONVERSION NOT IMPLEMENTED"));
        break;
    }
...
template <>
    void image_fill < Image < uint16_t, DEPTH > >(Image < uint16_t,
                          DEPTH > *img,
                          visionsystem::Frame * frm) {
    switch (frm->_coding) {
    case VS_DEPTH16:
    ...
    default:
        throw(string
              ("Image<uint16_t, DEPTH> : CONVERSION NOT IMPLEMENTED"));
        break;
    }
}
